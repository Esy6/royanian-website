<?php
    $empfaenger = "e.royanian@gmail.com";  // Bitte tragen Sie hier Ihre E-Mail Adresse ein. (zwischen den Anführungszeichen)
    $ihrname = "Royan Trading GmbH"; // Bitte tragen Sie hier Ihren Namen ein. (zwischen den Anführungszeichen) Dieser erscheint als Absender in der Danke Mail.
    ...
    $zeichenlaenge_ort = "50"; // Maximale Zeichen - Feld "Ort" (zwischen den Anführungszeichen)
